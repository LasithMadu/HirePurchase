    ...
    return(
        <div className={"col-lg-" + size[0] + "col-md-" + size[1] + " col-sm-" + size[2] + " col-xs-" + size[3]} style={{ height: '85px', position: 'relative' }}>
            <div className="form-group">
                ...
                {
                    enable ? 
                    <input className={"bp3-input bp3-fill modifier sInput" + classN} disabled={true} name={id} id={id} style={{ border: '1px solid black', borderRadius: '0px' }} value={placeholder} type={type} dir="auto" /> :
