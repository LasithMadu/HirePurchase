...
export default class SlideBar extends Component {
    ...
    render () {
        ...
        const subMenu = (
            <ul className="nav sidehigh">
                <div className="clearfix"></div>
                <li style={styleSheet.themColor} className={this.state.activeItem === "9" ? "active" : ""} onClick={this.toggle("9")}><NavLink to="/higher/items" style={{paddingLeft: '70px'}} activeStyle={{ background: sessionStorage.getItem('bgColor') }}  onClick={()=>this.props.setLocation('VEHICLE')}><i className="fa fa-edit fa-fw">
                    <div className="icon-bg bg-violet"></div>
                    </i><span className="menu-title">Vehicles</span></NavLink>
                </li>
                <li style={styleSheet.themColor} className={this.state.activeItem === "10" ? "active" : ""} onClick={this.toggle("10")}><NavLink to="/higher/lands" style={{paddingLeft: '70px'}} activeStyle={{ background: sessionStorage.getItem('bgColor') }}  onClick={()=>this.props.setLocation('LAND')}><i className="fa fa-edit fa-fw">
                    <div className="icon-bg bg-violet"></div>
                    </i><span className="menu-title">Lands</span></NavLink>
                </li>
                <li style={styleSheet.themColor} className={this.state.activeItem === "11" ? "active" : ""} onClick={this.toggle("11")}><NavLink to="/higher/other" style={{paddingLeft: '70px'}} activeStyle={{ background: sessionStorage.getItem('bgColor') }}  onClick={()=>this.props.setLocation('OTHER')}><i className="fa fa-edit fa-fw">
                    <div className="icon-bg bg-violet"></div>
        ...
        const dropMenu = (
            <ul className="nav sidehigh">
                ...
                <li style={styleSheet.themColor} className={this.state.activeItem === "6" ? "active" : ""} onClick={this.toggle("6")}><NavLink to="/higher/agreement" style={{paddingLeft: '35px'}} activeStyle={{ background: sessionStorage.getItem('bgColor') }}  onClick={()=>this.props.setLocation('AGREEMENT')}><i className="fa fa-edit fa-fw">
                    <div className="icon-bg bg-violet"></div>
                    </i><span className="menu-title">Agreements</span></NavLink>
                </li>
                <li style={styleSheet.themColor} className={this.state.activeItem === "12" ? "active" : ""} onClick={this.toggle("12")}><NavLink to="/higher/payment" style={{paddingLeft: '35px'}} activeStyle={{ background: sessionStorage.getItem('bgColor') }}  onClick={()=>this.props.setLocation('PAYMENT')}><i className="fa fa-edit fa-fw">
                    <div className="icon-bg bg-violet"></div>
                    </i><span className="menu-title">Payments</span></NavLink>
                </li>
                <li style={styleSheet.themColor} className={this.state.activeItem === "13" ? "" : ""} onClick={this.toggle("13")}><NavLink to="/higher/reminder" style={{paddingLeft: '35px'}} activeStyle={{ background: sessionStorage.getItem('bgColor') }}  onClick={()=>this.props.setLocation('REMINDER')}><i className="fa fa-edit fa-fw">
                    <div className="icon-bg bg-violet"></div>
                    </i><span className="menu-title">Reminders</span></NavLink>
                    {/* { this.state.reminder ? reminders : ""} */}
                </li>
                <li style={styleSheet.themColor} className={this.state.activeItem === "8" ? "active" : ""} onClick={this.toggle("8")}><NavLink to="/higher/report" style={{paddingLeft: '35px'}} activeStyle={{ background: sessionStorage.getItem('bgColor') }}  onClick={()=>this.props.setLocation('REPORTS')}><i className="fa fa-edit fa-fw">
                    <div className="icon-bg bg-violet"></div>
            ...
            <nav id="sidebar" role="navigation" data-step="2" data-intro="Template has &lt;b&gt;many navigation styles&lt;/b&gt;"
                ...
                <div className="sidebar-collapse menu-scroll">
                    <ul id="side-menu" className="nav">
                        ...
                        <div className="clearfix"></div>
                        <li style={styleSheet.themColor} className={this.state.activeItem === "1" ? "active" : ""} onClick={this.toggle("1")}><NavLink to="/customer" activeStyle={{ background: sessionStorage.getItem('bgColor') }} onClick={()=>this.props.setLocation('CUSTOMER')}>
