...
var container_tabs_ = __webpack_require__(7);
...
function (_ControlledComponent) {
  _inherits(Tabs, _ControlledComponent);
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          otherProps = _objectWithoutProperties(_this$props, ["vertical", "children", "onChange"]);

      var _this$getControlledSt = this.getControlledState(),
          selectedKey = _this$getControlledSt.selectedKey;

      return external_react_default.a.createElement(container_tabs_["TabsContainer"], {
        ...
        onSelect: function onSelect(item) {
          if (onChange) {
            ...
            _this2.setControlledState({
              selectedKey: item
            });
          }
        }
      }, function (_ref) {
        var getTabListProps = _ref.getTabListProps,
            getTabPanelProps = _ref.getTabPanelProps,
            getTabProps = _ref.getTabProps,
        ...
        return external_react_default.a.createElement(views_TabsView, _extends({
          ...
          if (typeof _this2.firstKey === 'undefined') {
            _this2.firstKey = key;
          }
          ...
          var _child$props2 = child.props,
              ...
              other = _objectWithoutProperties(_child$props2, ["tabProps"]);
  ...
  return Tabs;
}(react_selection_["ControlledComponent"]);

Tabs_defineProperty(Tabs_Tabs, "propTypes", {
...
Tabs_defineProperty(Tabs_Tabs, "defaultProps", {
  vertical: false
});

/* harmony default export */ var elements_Tabs = (Object(react_theming_["withTheme"])(Tabs_Tabs));
// CONCATENATED MODULE: ./src/containers/TabsContainer.js
function TabsContainer_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { TabsContainer_typeof = function _typeof(obj) { return typeof obj; }; } else { TabsContainer_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return TabsContainer_typeof(obj); }

function TabsContainer_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function TabsContainer_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { TabsContainer_ownKeys(source, true).forEach(function (key) { TabsContainer_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { TabsContainer_ownKeys(source).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function TabsContainer_objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = TabsContainer_objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }

function TabsContainer_objectWithoutPropertiesLoose(source, excluded) { if (source == null) return {}; var target = {}; var sourceKeys = Object.keys(source); var key, i; for (i = 0; i < sourceKeys.length; i++) { key = sourceKeys[i]; if (excluded.indexOf(key) >= 0) continue; target[key] = source[key]; } return target; }
...
function TabsContainer_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function TabsContainer_createClass(Constructor, protoProps, staticProps) { if (protoProps) TabsContainer_defineProperties(Constructor.prototype, protoProps); if (staticProps) TabsContainer_defineProperties(Constructor, staticProps); return Constructor; }

function TabsContainer_possibleConstructorReturn(self, call) { if (call && (TabsContainer_typeof(call) === "object" || typeof call === "function")) { return call; } return TabsContainer_assertThisInitialized(self); }

function TabsContainer_getPrototypeOf(o) { TabsContainer_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return TabsContainer_getPrototypeOf(o); }

function TabsContainer_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function TabsContainer_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) TabsContainer_setPrototypeOf(subClass, superClass); }

function TabsContainer_setPrototypeOf(o, p) { TabsContainer_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return TabsContainer_setPrototypeOf(o, p); }

function TabsContainer_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var TabsContainer_TabsContainer =
/*#__PURE__*/
function (_ControlledComponent) {
  TabsContainer_inherits(TabsContainer, _ControlledComponent);
  ...
  function TabsContainer() {
    ...
    _this = TabsContainer_possibleConstructorReturn(this, (_getPrototypeOf2 = TabsContainer_getPrototypeOf(TabsContainer)).call.apply(_getPrototypeOf2, [this].concat(args)));

    TabsContainer_defineProperty(TabsContainer_assertThisInitialized(_this), "onTabSelected", function (selectedKey) {
      var onChange = _this.props.onChange;
      onChange && onChange(selectedKey);
    });

    TabsContainer_defineProperty(TabsContainer_assertThisInitialized(_this), "getTabListProps", function () {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

      var _ref$role = _ref.role,
          role = _ref$role === void 0 ? 'tablist' : _ref$role,
          other = TabsContainer_objectWithoutProperties(_ref, ["role"]);

      return TabsContainer_objectSpread({
        role: role
      }, other);
    });

    TabsContainer_defineProperty(TabsContainer_assertThisInitialized(_this), "getTabProps", function () {
      var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

      var _ref2$role = _ref2.role,
          role = _ref2$role === void 0 ? 'tab' : _ref2$role,
          key = _ref2.key,
          other = TabsContainer_objectWithoutProperties(_ref2, ["role", "key"]);

      if (typeof key === 'undefined' || key === null) {
        throw new Error('"key" must be defined within getTabProps regardless of being used within a .map()');
      }
    ...
    TabsContainer_defineProperty(TabsContainer_assertThisInitialized(_this), "getTabPanelProps", function () {
      var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

      var _ref3$role = _ref3.role,
          role = _ref3$role === void 0 ? 'tabpanel' : _ref3$role,
          key = _ref3.key,
          other = TabsContainer_objectWithoutProperties(_ref3, ["role", "key"]);

      if (typeof key === 'undefined' || key === null) {
        throw new Error('"key" must be defined within getTabPanelProps regardless of being used within a .map()');
      }

      var _this$getControlledSt = _this.getControlledState(),
          selectedKey = _this$getControlledSt.selectedKey;

      var isHidden = key !== selectedKey;
      return TabsContainer_objectSpread({
        key: key,
        role: role,
    ...
    _this.state = {
      ...
      selectedKey: undefined,
      id: react_selection_["IdManager"].generateId('garden-tabs-container')
    };
    return _this;
  } // eslint-disable-next-line class-methods-use-this


  TabsContainer_createClass(TabsContainer, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      if (false) {}
    }
    ...
    value: function render() {
      ...
      var _this$getControlledSt2 = this.getControlledState(),
          focusedKey = _this$getControlledSt2.focusedKey,
          selectedKey = _this$getControlledSt2.selectedKey,
          id = _this$getControlledSt2.id;

      return external_react_default.a.createElement(react_selection_["SelectionContainer"], {
        id: id,
        ...
        onStateChange: function onStateChange(newState) {
          ...
          if (Object.prototype.hasOwnProperty.call(newState, 'selectedKey')) {
            _this2.onTabSelected(newState.selectedKey);
          }

          _this2.setControlledState(newState);
        }
      }, function (_ref4) {
        var getContainerProps = _ref4.getContainerProps,
            getItemProps = _ref4.getItemProps;
        return render({
          getTabListProps: function getTabListProps(props) {
            return getContainerProps(_this2.getTabListProps(props));
          },
          getTabProps: function getTabProps(props) {
            return getItemProps(_this2.getTabProps(props));
          },
          getTabPanelProps: _this2.getTabPanelProps,
          focusedKey: focusedKey,
          selectedKey: selectedKey
        });
      });
...
TabsContainer_defineProperty(TabsContainer_TabsContainer, "propTypes", {
  /**
   ...
   */
  focusedKey: external_prop_types_default.a.oneOfType([external_prop_types_default.a.number, external_prop_types_default.a.string]),

  /**
   * The currently selected key
   */
  selectedKey: external_prop_types_default.a.oneOfType([external_prop_types_default.a.number, external_prop_types_default.a.string]),
...
TabsContainer_defineProperty(TabsContainer_TabsContainer, "defaultProps", {
  vertical: false
});
...
/* concated harmony reexport TabsContainer */__webpack_require__.d(__webpack_exports__, "TabsContainer", function() { return TabsContainer_TabsContainer; });
